...
const Checkout = () => {
  ...
  return (
    <div>
     <UserNavbar/>
     <section className='py-4 px-3 px-lg-5' style={{backgroundColor:'#FCFCFC'}}>
        <div className='px-lg-5'>
            <div className='mx-xl-5 bg-white '>
    ...
    <span className="required-indicator" style={{left: '26%',top: '18%'}}>*</span>
    </div>
    ...
    <span className="required-indicator" style={{left: '33%',top: '18%'}}>*</span>
    </div>
    ...
    <span className="required-indicator" style={{left: '35%',top: '18%'}}>*</span>
    </div>
                        </Col>
    ...
    <span className="required-indicator" style={{left: '24%',top: '18%'}}>*</span>
    </div>
    ...
    <span className="required-indicator" style={{left: '42%',top: '18%'}}>*</span>
    </div>
                        </Col>
    ...
    <Form.Control type="text" id="additionalAddress" placeholder="Additional Address" style={{backgroundColor:'#FCFCFC', border:'none'}} value={additionalAddress} required onChange={handleAdditionalAddressChange}/>
                    ...
                    <Row>
<Col xs={12} md={4}>
<div className="d-flex gap-2 align-items-center px-2 py-1 w-100" style={{backgroundColor:'#FCFCFC', border:'none', fontSize:'12px'}} >
    <span>Address Label(optional)</span>
...
<Form.Check variant='danger'
    ...
    <div>
        ...
        <Form onSubmit={() => handleButtonClick(3)}>
                    <div  className='mb-5'>
                        ...
                        <Row>
                            ...
                            <div className='pt-3 mb-5' style={{backgroundColor:'#FAFCFE'}}>
                                <p className='px-3 mb-5' style={{color:'#0D111B'}}>Review your Order</p>
                                    {cartItems.map((item)=> (
                                        <div className=' d-flex justify-content-between px-3' style={{borderBottom:'1px solid #dfdcdc'}} key={item?.id}>
...
{selectedButton === 3 && (
    ...
    <div className='p-5'>
        ...
        <div className='mt-5'>
            <Button variant='danger' className='py-3 px-4' onClick={()=> navigate('/')}>Continue Shopping</Button>
            </div>
            </div >
