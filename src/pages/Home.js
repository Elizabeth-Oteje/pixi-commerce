...
import { Container, Card, Row, Image, Col, Carousel, Button, Spinner} from 'react-bootstrap'
...
const CarouselCards = ()=> {
    return (
        <div className=' row px-4 py-md-2 py-4 '>
        ...
        <div  className=''> <h1 >Up to 60% off Voucher</h1></div>
       ...
       <i className="bi bi-arrow-right"></i>
        ...
        <div className='col-12 col-sm-7 col-xl-8 justify-content-center align-items-center text-center'>
...
const handleShowModal = (product) => {
  ...
  return (
    <div>
        ...
        <Card className='d-flex px-2 px-lg-5 mb-5' style={{backgroundColor:'black', borderRadius:'0px'}}>
      ...
      <Carousel.Item interval={1500}>
       <CarouselCards/>
        ...
        <section className='my-5 pb-5'>
            <div className='d-flex align-items-center gap-3 mt-lg-5 mb-3 pt-lg-5 pt-3 '>
            ...
            <i className="bi bi-phone" style={{fontSize:'3rem',opacity: '60%'}}></i>
            <h6 style={{fontWeight:'400'}}>Phones</h6>
            </button>
            <button className={selectedButton ===1 ? 'active-jobs-button col py-2' : 'jobs-button col py-2'} onClick={() => handleButtonClick(1)}>
            <i className="bi bi-pc-display-horizontal"  style={{fontSize:'3rem',opacity: '60%'}}></i>
            <h6 style={{fontWeight:'400'}}>Computers</h6>
            </button>
            <button className={selectedButton === 2 ? 'active-jobs-button col py-2' : 'jobs-button col py-2'} onClick={() => handleButtonClick(2)}>
            <i className="bi bi-smartwatch" style={{fontSize:'3rem',opacity: '60%'}}></i>
            <h6 style={{fontWeight:'400'}}>SmartWatch</h6>
            </button>
            <button className={selectedButton === 3 ? 'active-jobs-button col py-2' : 'jobs-button col py-2'} onClick={() => handleButtonClick(3)}>
            <i className="bi bi-camera" style={{fontSize:'3rem',opacity: '60%'}}></i>
            < h6 style={{fontWeight:'400'}}>Camera</h6>
            </button>
            <button className={selectedButton === 4 ? 'active-jobs-button col py-2' : 'jobs-button col py-2'} onClick={() => handleButtonClick(4)}>
            <i className="bi bi-headphones" style={{fontSize:'3rem',opacity: '60%'}}></i>
            <h6 style={{fontWeight:'400'}}>Headphones</h6>
            </button>
            <button className={selectedButton === 5 ? 'active-jobs-button col py-2' : 'jobs-button col py-2'} onClick={() => handleButtonClick(5)}>
            <i className="bi bi-controller" style={{fontSize:'3rem',opacity: '60%'}}></i>
            <h6 style={{fontWeight:'400'}}>Gaming</h6>
            </button>
           
            </Row>
           
        </section>
        <div style={{borderBottom:'1px solid #dfdcdc'}} className=''>

        </div>
        <Card className='d-flex px-2 px-lg-5 py-md-2 py-4 my-5 custom-carder' style={{backgroundColor:'black', borderRadius:'0px'}}>
       
        <Row className=' px-4'>
        <Col xs={12} sm={5} xl={6} className='text-white d-flex flex-column gap-2 gap-xl-4 py-md-5 mb-3'>
      
        <h6 style={{color:"#DB4444", fontWeight:'600'}}>Categories</h6>
        ...
        <section className='my-5'>
            <div className='d-flex align-items-center gap-3 mt-lg-5 pt-lg-5 pt-3 mb-3'>
                <div className='px-2 py-3' style={{backgroundColor:"#DB4444", borderRadius:"5px"}}></div>
                <h6 style={{color:"#DB4444", fontWeight:'600'}} className='my-auto'>Our Products</h6>
            </div>
